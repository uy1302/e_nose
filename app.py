...
def fetch_thingspeak_data(api_key):
    try:
...
def process_thingspeak_data(data):
    ...
    try:
        ...
        st.error(f"Error processing sensor values: {str(e)}")
        return None
